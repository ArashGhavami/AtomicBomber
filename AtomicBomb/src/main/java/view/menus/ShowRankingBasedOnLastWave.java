...
public class ShowRankingBasedOnLastWave extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        ArrayList<User> allUsers = getArrayListOfUsersBasedOnKills();
    ...
    public ArrayList<User> getArrayListOfUsersBasedOnKills() {
        ArrayList<User> allUsers = User.getAllUsers();
        ArrayList<Double> usersKills = new ArrayList<>();
    ...
    public double getUserKill(User user) {
        double averageLastWave = 0;
        for (GameLauncher gameLauncher : user.getGameLaunchers()) {
            averageLastWave += gameLauncher.getWhichWave();
        }
        averageLastWave = averageLastWave/ user.getGameLaunchers().size();
        return averageLastWave;
    }
